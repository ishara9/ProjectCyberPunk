    ...
    public void UpdateMovmentSystem(MovingAgent.CharacterMainStates characterState,Vector3 movmentDirection)
    {
        ...
        switch (m_characterState)
        {
            case MovingAgent.CharacterMainStates.Aimed:
                ...
                // Move Character
                Vector3 moveDiection = movmentDirection;
                moveDiection = this.m_characterTransform.InverseTransformDirection(moveDiection);
            ...
            case MovingAgent.CharacterMainStates.Idle:
                ...
                {
                    Vector3 moveDirection = new Vector3(movmentDirection.z, 0, -movmentDirection.x);
